...
?>
	...
	public static function page_jquery($arg)
	{
	?>
		<script type="text/javascript" src="<?php print_link(jquery_DIR . $arg); ?>"></script>
	<?php
	}
	public static function page_template($arg)
	{
	?>
		<script type="text/javascript" src="<?php print_link(template_DIR . $arg); ?>"></script>
	<?php
	}
	public static function page_simplebar($arg)
	{
	?>
		<script type="text/javascript" src="<?php print_link(simplebar_DIR . $arg); ?>"></script>
		<?php
	}
	...
	public static function render_menu($arrMenu, $menu_class = "nav navbar-nav", $menu_type = "dropdown")
	{
		...
		if (!empty($arrMenu)) {
		?>
			<ul id="<?php echo $menu_group_id; ?> sidebarnav">
				...
				?>
							<li class="sidebar-item <?php echo $menu_link_class;  ?>">
								<a class="sidebar-link <?php echo $submenu_link_class;  ?>" href="#<?php echo $menu_id; ?>" data-boundary="viewport" data-toggle="<?php echo $data_toggle;  ?>">
									<?php echo (!empty($menuobj['icon']) ? $menuobj['icon'] : null); ?>
									<span class="hide-menu"><?php echo $menuobj['label']; ?></span>
								</a>
								<?php
						...
						?>
							<li class="sidebar-item">
								<a class="sidebar-link <?php echo ($active_class) ?>" href="<?php print_link($path); ?>">
									<?php echo (!empty($menuobj['icon']) ? $menuobj['icon'] : null); ?>
									<span class=" hide-menu"><?php echo $menuobj['label']; ?></span>
								</a>
							</li>
				...
				<li class="sidebar-item">
					<a class="sidebar-link " href="<?php print_link('index/logout?csrf_token=' . Csrf::$token) ?>">
	...
	?>
		...
		?>
			<span class="sort-icon dropdown-toggle"></span> <!-- <i class="fa fa-arrow-up"></i> -->
		<?php
		} else {
		?>
			<span class="sort-icon dropdown-toggle inverse text-muted"></span> <!-- <i class="fa fa-arrow-down"></i> -->
		<?php
		}
		?>
	<?php
