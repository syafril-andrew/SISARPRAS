							...
							<div>
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-sm-8">
											<div class="">
												<input id="ctrl-merek_barang" value="<?php echo $data['merek_barang']; ?>" type="text" placeholder="Enter Merek Barang" required="" name="merek_barang" class="form-control " />
											</div>
										</div>
									</div>
								</div>
								...
								<input id="ctrl-tanggal_input" value="<?php echo $data['tanggal_input']; ?>" type="hidden" placeholder="Enter Tanggal Input" required="" name="tanggal_input" class="form-control " />
							</div>
